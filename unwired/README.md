...
| `ui-comparison/` | Skill de fidelidade visual de um projeto de origem | O método (fases, rubrica de score) é genérico; sem design system real pra testar contra, não tinha como comprovar uso aqui. `figma-to-component` (que vivia neste mesmo par) foi promovido em 2026-07-07 — ver `plugins/core/skills/figma-to-component/`. |
