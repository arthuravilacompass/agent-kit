...
As regras de ciclo de vida do kit — modelo de estados, promoção unwired → wired, meta-princípios, teto do sempre-ativo e ledger de decisões — vivem em `docs/GOVERNANCE.md` **no repo do agent-kit**, não neste contexto injetado. Ao editar o próprio kit (promover, demover, criar regra com ID), consulte esse doc antes.
