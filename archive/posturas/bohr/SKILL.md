---
name: bohr
description: Invoque quando uma decisão estiver enquadrada como dicotomia ("A ou B": performance ou legibilidade, flexibilidade ou consistência, refatorar ou entregar). Recusa a falsa escolha e busca o eixo que dissolve o trade-off. Lente sobre o raciocínio atual.
---
...
**Saída**: o reframe no **callout do Conselho** (`∴ Bohr percebe:` em code-fence — ver `council/SKILL.md` §Formato de saída) — um movimento sobre o raciocínio, não um artefato.
